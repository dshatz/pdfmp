...
@CName("Java_com_dshatz_pdfmp_imagebuffer_ImageBufferUtil_lockBitmap")
fun lockBitmap(env: CPointer<JNIEnvVar>, thiz: jclass, bitmap: jobject): jobject? {
    memScoped {
        ...
        val dimsCls = jni.FindClass!!(env, "com/dshatz/pdfmp/imagebuffer/BufferDimensions".cstr.ptr)
        ...
        // Class Path: com/dshatz/pdfmp/imagebuffer/BufferInfo
        // Signature: (Lcom/dshatz/pdfmp/imagebuffer/BufferDimensions;J)V -> dimensionsObj, address
        val infoCls = jni.FindClass!!(env, "com/dshatz/pdfmp/imagebuffer/BufferInfo".cstr.ptr)
        val infoCtor = jni.GetMethodID!!(env, infoCls, "<init>".cstr.ptr, "(Lcom/dshatz/pdfmp/imagebuffer/BufferDimensions;J)V".cstr.ptr)
...
@OptIn(ExperimentalForeignApi::class, ExperimentalNativeApi::class)
@CName("Java_com_dshatz_pdfmp_imagebuffer_ImageBufferUtil_unlockBitmap")
